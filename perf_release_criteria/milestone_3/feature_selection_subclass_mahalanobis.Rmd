---
title: "Milestone 2: Feature Selection - Subclassing, Malahanobis"
...
results_file_name <- 'feature_selection_subclass_mahalanobis.RData' 
...
res_fs1 <- list()
for (bt in names(bts)){
  res_fs1[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs1, size=NULL,  workers = 10, 
                                      method = "subclass", distance = "mahalanobis")
}
...
res_fs2 <- list()
for (bt in names(bts)){
  res_fs2[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs2, size=NULL,  workers = 10, method = "subclass", distance = "mahalanobis")
}
save.image(results_file_path)
print(res_fs2)
```
...
res_fs3 <- list()
for (bt in names(bts)){
  res_fs3[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs3, size=NULL,  workers = 10, 
                                      method = "subclass", distance = "mahalanobis")
}
save.image(results_file_path)
print(res_fs3)
...
res_fs4 <- list()
for (bt in names(bts)){
  res_fs4[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs4, size=NULL,  workers = 10, 
                                      method = "subclass", distance = "mahalanobis")
}
save.image(results_file_path)
print(res_fs4)
...
res_fs5 <- list()
for (bt in names(bts)){
  res_fs5[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs5, size=NULL,  workers = 10, 
                                      method = "subclass", distance = "mahalanobis")
}
save.image(results_file_path)
print(res_fs5)
...
res_fs6 <- list()
for (bt in names(bts)){
  res_fs6[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs6, size=NULL,  workers = 10, 
                                      method = "subclass", distance = "mahalanobis")
}
save.image(results_file_path)
print(res_fs6)
...
res_fs7 <- list()
for (bt in names(bts)){
  res_fs7[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs7, size=NULL,  workers = 10,
                                      method = "subclass", distance = "mahalanobis")
}
save.image(results_file_path)
print(res_fs7)
...
Subclassing appeared to do very little, as the feature sets had no influence. 
