---
title: "Milestone 2: Feature Selection - Subclassing, GAM Logit"
...
results_file_name <- 'feature_selection_subclass_gam_logit.RData' 
...
for (bt in names(bts)){
  res_fs1[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs1, size=NULL,  workers = 10, 
                                      method = "subclass", distance = 'GAMlogit')
}
...
res_fs2 <- list()
for (bt in names(bts)){
  res_fs2[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs2, size=NULL,  workers = 10, method = "subclass", distance = 'GAMlogit')
}
save.image(results_file_path)
print(res_fs2)
```
