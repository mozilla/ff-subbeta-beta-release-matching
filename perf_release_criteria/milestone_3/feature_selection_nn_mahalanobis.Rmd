...
res_fs1 <- list()
for (bt in names(bts)){
  res_fs1[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs1, size=50000, replace=TRUE, workers = 5)
}
...
for (bt in names(bts)){
  res_fs1_noreplace[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs1, size=50000, replace=FALSE, workers = 5)
}
save.image(results_file_path)
...
res_fs2 <- list()
for (bt in names(bts)){
  res_fs2[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs2, size=50000, replace=TRUE, workers = 5)
}
save.image(results_file_path)
print(res_fs2)
```
...
for (bt in names(bts)){
  res_fs2_noreplace[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs2, size=50000, replace=FALSE, workers = 5)
}
save.image(results_file_path)
...
res_fs3 <- list()
for (bt in names(bts)){
  res_fs3[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs3, size=50000, replace=TRUE, workers = 5)
}
save.image(results_file_path)
print(res_fs3)
```
...
for (bt in names(bts)){
  res_fs3_noreplace[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs3, size=50000, replace=FALSE, workers = 5)
}
save.image(results_file_path)
...
res_fs4 <- list()
for (bt in names(bts)){
  res_fs4[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs4, size=50000, replace=TRUE, workers = 5)
}
save.image(results_file_path)
print(res_fs4)
```
...
for (bt in names(bts)){
  res_fs4_noreplace[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs4, size=50000, replace=FALSE, workers = 5)
}
save.image(results_file_path)
...
res_fs5 <- list()
for (bt in names(bts)){
  res_fs5[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs5, size=50000, replace=TRUE, workers = 5)
}
save.image(results_file_path)
print(res_fs5)
```
...
for (bt in names(bts)){
  res_fs5_noreplace[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs5, size=50000, replace=FALSE, workers = 5)
}
save.image(results_file_path)
...
res_fs6 <- list()
for (bt in names(bts)){
  res_fs6[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs6, size=50000, replace=TRUE, workers = 5)
}
save.image(results_file_path)
print(res_fs6)
```
...
for (bt in names(bts)){
  res_fs6_noreplace[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs6, size=50000, replace=FALSE, workers = 5)
}
save.image(results_file_path)
...
res_fs7 <- list()
for (bt in names(bts)){
  res_fs7[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs7, size=50000, replace=TRUE, workers = 5)
}
save.image(results_file_path)
print(res_fs7)
```
...
for (bt in names(bts)){
  res_fs7_noreplace[[bt]] <- perform_matchit_fs(df_train_f, bts[[bt]], fs7, size=50000, replace=FALSE, workers = 5)
}
save.image(results_file_path)
