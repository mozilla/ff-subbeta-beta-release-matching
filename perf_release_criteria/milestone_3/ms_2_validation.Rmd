...
* Determined in `hyperparameter_tuning_nn_malahanobis.Rmd`
*

```{r nn_mal}
nn.mal <- train_matchit(dfs[['4']], fs1, add_interactions = FALSE, replace = FALSE, distance = "mahalanobis")
```

# Serialize

* The bootsraps and training datasets!
