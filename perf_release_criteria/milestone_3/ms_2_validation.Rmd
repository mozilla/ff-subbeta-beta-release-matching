...
nn.mal.fs1.qq <- build_quantile_df(df_rel_val, nn.mal.fs1$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.mal.fs1$matched, df_beta_train, nn.mal.fs1.qq)
```
...
nn.mal.fs3.qq <- build_quantile_df(df_rel_val, nn.mal.fs3$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.mal.fs3$matched, df_beta_train)
```
...
nn.mal.fs5.qq <- build_quantile_df(df_rel_val, nn.mal.fs5$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.mal.fs5$matched, df_beta_train)
```
...
nn.linear.logit.fs1.qq <- build_quantile_df(df_rel_val, nn.linear.logit.fs1$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.linear.logit.fs1$matched, df_beta_train)
```
...
nn.linear.logit.fs5.qq <- build_quantile_df(df_rel_val, nn.linear.logit.fs5$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.linear.logit.fs5$matched, df_beta_train)
```
...
nn.gam.fs1.qq <- build_quantile_df(df_rel_val, nn.gam.fs1$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.gam.fs1$matched, df_beta_train)
```
...
nn.gam.fs5.qq <- build_quantile_df(df_rel_val, nn.gam.fs5$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.gam.fs5$matched, df_beta_train)
```
...
nn.linear.probit.fs1.qq <- build_quantile_df(df_rel_val, nn.linear.probit.fs1$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.linear.probit.fs1$matched, df_beta_train)
```
...
nn.linear.probit.fs5.qq <- build_quantile_df(df_rel_val, nn.linear.probit.fs5$matched, df_beta_train)
...
plot_validation_results(df_rel_val, nn.linear.probit.fs5$matched, df_beta_train)
```
...
genmatch.fs1.qq <- build_quantile_df(df_rel_val, genmatch.fs1.matched, df_beta_train)
...
plot_validation_results(df_rel_val, genmatch.fs1.matched, df_beta_train)
```
...
genmatch.fs1.500.qq <- build_quantile_df(df_rel_val, genmatch.fs1.500.matched, df_beta_train)
...
plot_validation_results(df_rel_val, genmatch.fs1.500.matched, df_beta_train)
```
...
genmatch.fs3.qq <- build_quantile_df(df_rel_val, genmatch.fs3.matched, df_beta_train)
...
plot_validation_results(df_rel_val, genmatch.fs3.matched, df_beta_train)
```
...
genmatch.fs5.qq <- build_quantile_df(df_rel_val, genmatch.fs5.matched, df_beta_train)
...
plot_validation_results(df_rel_val, genmatch.fs5.matched, df_beta_train)
```
